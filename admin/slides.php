                              ...
                              <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                 ...
                                 <div class="col-12 col-sm-6 col-md-8">
                                        ...
                                        <div class="col-6 col-md-4">
                                            ...
                                            <a href="form-slides.php" ><img src="../uploads/create2.png" style="width: 30px; height:30px; margin:  20px; margin-left:80px;"></a>
                                            <a href="#" ><img src="../uploads/delete7.png" style="width: 40px; margin:  20px;  margin-left:90px;"></a>
