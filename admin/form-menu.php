              ...
              <div class="row">
                ...
                <div class="col-8">
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    ...
                    ?>
                      <div class="tab-pane fade show <?php if ($row['code'] == 'az') echo 'active' ?>" id="nav-<?= $row['code']; ?>" role="tabpanel" aria-labelledby="nav-<?= $row['code']; ?>-tab">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="translation[<?= $row['id'] ?>][name]" id="exampleFormControlInput1">
                        </div>
                        <div class="form-group">
                          <label for="exampleFormControlInput1" class="form-label">Slug</label>
                          <input type="text" name="translation[<?= $row['id'] ?>][slug]" class="form-control" id="exampleFormControlInput1">
                        </div>
                    ...
                    <div class="form-group">
                      <button type="submit" href="form-menu.php" class="btn btn-primary" style="margin-top:5%; margin-left: 40%; margin-right:50%; width: 10em;" value="Submit">Yadda saxla</button>
                    </div>
                  </div>
